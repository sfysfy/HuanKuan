...
import com.repayment.money.common.utils.pay.Constants.PAY_MODE;
...
public class MobileSecurePayer {
    ...
    PAY_MODE mPayMode = PAY_MODE.PAY_COMMON;
    ...
    public boolean pay(String strOrderInfo, final Handler callback,
                       ...
                       boolean isTest) {
    	return pay(strOrderInfo, callback, myWhat, activity, pay_product, signCard, isTest, PAY_MODE.PAY_COMMON);
    }
    ...
    public boolean pay(String strOrderInfo, final Handler callback,
                       final int myWhat, final Activity activity, String pay_product, boolean signCard,
                       boolean isTest, final PAY_MODE pay_mode) {
        if (mbPaying)
            return false;
        mbPaying = true;
