...
public class PayOrder implements Serializable {
    ...
    private String fund_attach;//基金公司附加数据
    private String fund_no;//基金代码
    private String trans_type;//交易类型
    private String settle_date;//基金清算日期
	...
	public String getFund_attach() {
		return fund_attach;
	}

	public void setFund_attach(String fund_attach) {
		this.fund_attach = fund_attach;
	}
	...
	public void setTrans_type(String fund_type) {
		this.trans_type = fund_type;
	}
